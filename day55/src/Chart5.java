...
public class Chart5 {
    ChartPanel frame1;
    public Chart5(String title,String data1,String data2,String year,int miu) throws SQLException {
    ...
    public Chart5(String title,String data1,String data2,String data3,String year,int miu) throws SQLException {
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-4),a/b*100);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-3),a/b*100);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-2),a/b*100);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-1),a/b*100);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu),a/b*100);
                }
            }
        }
        return timeseries;
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-4),(a+b)*100/c);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-3),(a+b)*100/c);
                }
            }
        }
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-2),(a+b)*100/c);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu-1),(a+b)*100/c);
                }
            }
        }
        ...
        try(Connection connection = DUtil.getConnection()) {
            ...
            try(PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                try(ResultSet r = ps.executeQuery()) {
                    ...
                    timeseries.add(new Year(miu),(a+b)*100/c);
                }
            }
        }
    ...
    public static JFrame transfer(String year,int miu) throws SQLException {
        JFrame frame=new JFrame("盈利能力分析");
        frame.setLayout(new GridLayout(2,2,10,10));
        frame.add(new Chart5("资产净利率","净利润","平资产",year,miu).getChartPanel());
        frame.add(new Chart5("权益净利率","净利润","股东权益合计",year,miu).getChartPanel());
        frame.add(new Chart5("销售净利率","净利润","营业收入",year,miu).getChartPanel());
        frame.add(new Chart5("成本费用净利率","净利润","营业成本",year,miu).getChartPanel());
